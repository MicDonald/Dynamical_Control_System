...
constexpr MKL_INT width = 1;
constexpr MKL_INT nLayers = 1;
constexpr MKL_INT aWidth = 0;
constexpr MKL_INT cWidth = 0;
constexpr double dt =   0.01; // ps
constexpr double tmax = 100.; // ps
#define POTENTIAL potential(1,1)
//#define POTENTIAL potential(13.5317091, 3.821983274) //Ar-Harmonic in metal
//#define POTENTIAL potential(0.010340808, 3.4) //Ar-LJ in lj
//#define POTENTIAL potential(0.2381, 3.4050) //Ar-LJ in metal
...
void SerialVersion (double latticeSpacing, double cutoff, double mass)
{
	...
	std::cout<<"matrix size: "<<latticeMatrix.size()<<"\n";
	std::cout<<"dof: "<<dof<<"\n";
	std::cout<<"eVector size: "<<eigenvalues.size()<<"\n";
...
//cout << endl;
	...
	std::cout<<"eValues size: "<<eValues.size()<<"\n";
